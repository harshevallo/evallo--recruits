...
export function HeroAppMockup() {
  return (
    <div className="relative mx-auto mt-20 max-w-5xl" aria-hidden="true">
      ...
      <div className="relative overflow-hidden rounded-t-xl border border-b-0 border-gray-200 bg-white p-4 shadow-2xl">
        {/* Browser chrome */}
        ...
        <div className="grid grid-cols-1 gap-6 opacity-80 md:grid-cols-3">
          {/* Sidebar */}
          <div className="col-span-1 rounded-lg border border-gray-200 bg-white/50 p-4">
            <div className="mb-4 h-8 w-full rounded bg-white" />
            <div className="mb-2 h-4 w-3/4 rounded bg-white" />
            <div className="mb-6 h-4 w-1/2 rounded bg-white" />
            <div className="space-y-3">
              <div className="h-12 w-full rounded-md bg-white" />
              <div className="h-12 w-full rounded-md bg-white" />
              <div className="h-12 w-full rounded-md border border-brand-blue/30 bg-white" />
            </div>
          </div>

          {/* Detail pane */}
          <div className="col-span-2 rounded-lg border border-gray-200 bg-white/50 p-6">
            <div className="mb-6 flex items-start gap-4">
              <div className="h-16 w-16 flex-shrink-0 rounded-full bg-gray-700" />
              <div>
                <div className="mb-2 h-6 w-48 rounded bg-gray-700" />
                <div className="mb-2 h-4 w-32 rounded bg-white" />
            ...
            <div className="mb-4 flex h-32 w-full items-center justify-center rounded-lg bg-white">
              <Icon name="circle-play" className="text-4xl text-gray-600" />
            </div>

            <div className="mb-2 h-4 w-full rounded bg-white" />
            <div className="mb-2 h-4 w-full rounded bg-white" />
